    ...
    <section className="py-32 px-6 relative mb-20">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-20 animate-fade-up">
          <div className="w-20 h-20 rounded-2xl flex items-center justify-center animate-fade-up" style={{ background: 'linear-gradient(135deg, hsl(0, 70%, 60%), hsl(0, 70%, 65%))', animationDelay: '0s', opacity: 0, animationFillMode: 'forwards' }}>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div 
                ...
                style={{ 
                  ...
                  opacity: 0, 
                  animationFillMode: 'forwards',
                  background: 'linear-gradient(135deg, hsl(0, 70%, 63%) 0%, hsl(0, 70%, 67%) 100%)',
                  boxShadow: '0 12px 40px -10px hsl(0 70% 60% / 0.5)',
                }}
              >
