        ...
        <div className="space-y-8">
          ...
          <div className="elevated-card animate-fade-up">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
              ...
              <span className="text-primary font-semibold text-lg whitespace-nowrap">May 2026</span>
            </div>
            
            <div className="bg-accent/10 rounded-2xl p-6 mb-6 border-l-4 border-primary">
          ...
          <div className="elevated-card animate-fade-up" style={{ animationDelay: '0.2s', opacity: 0, animationFillMode: 'forwards' }}>
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
              ...
              <span className="text-primary font-semibold text-lg whitespace-nowrap">September 2018 – May 2022</span>
            </div>
